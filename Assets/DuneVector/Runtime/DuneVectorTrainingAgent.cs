    ...
    public sealed class DuneVectorTrainingAgent : Agent
    {
        ...
        public override void OnActionReceived(ActionBuffers actions)
        {
            ...
            DroneRawInputFrame command = new DroneRawInputFrame
            {
                ...
                // Policy look branches are normalized held inputs, not one-frame
                // mouse deltas. Routing every curriculum stage through LookRate gives
                // the agent the configured controller turn speed and makes a full
                // randomized heading physically correctable within the hub budget.
                LookDelta = Vector2.zero,
                LookRate = lookCommand,
