...
namespace DuneVector
{
    ...
    internal sealed class DuneVectorPlayModeValidator : MonoBehaviour
    {
        ...
        private IEnumerator RunValidation()
        {
            ...
            int effectiveUnloadRadius = Mathf.Max(world.UnloadRadius, Mathf.Max(world.ActiveRadius, world.PreloadRadius));
            int maximumBoundedChunks = (effectiveUnloadRadius * 2 + 1) * (effectiveUnloadRadius * 2 + 1);
