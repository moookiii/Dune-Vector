...
namespace DuneVector
{
    ...
    public sealed class DuneVectorY2KSky : VolumeComponent
    {
        ...
        public ClampedFloatParameter ReactiveShockRingSawtoothAmount = new ClampedFloatParameter(0.42f, 0f, 1.5f);
        public ClampedFloatParameter ReactiveShockRingSawtoothFrequency = new ClampedFloatParameter(12f, 1f, 32f);
