...
namespace DuneVector
{
    ...
    public sealed class StormPyramidTuning
    {
        ...
        [Tooltip("Resources-relative backup path used to load the body prefab if its direct asset reference is missing.")]
        public string PrefabResourcePath = "annuitcoeptis/annuitcoeptisPrefab";
