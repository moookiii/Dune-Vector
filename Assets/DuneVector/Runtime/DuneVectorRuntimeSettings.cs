...
namespace DuneVector
{
    ...
    public sealed class HeatZoneTuning
    {
        ...
        [Range(8, 512)] public int GroundHeatPlumePatchCount = 180;
        [Range(1, 16)] public int GroundHeatPlumePatchSegments = 5;
        [Min(0.25f)] public float GroundHeatPlumeMinimumRadius = 2f;
