...
namespace DuneVector
{
    ...
    public sealed class CourierContractTuning
    {
        ...
        [Tooltip("Animator state entered by the Sand Ambusher attack trigger. The ambusher starts its final dive after this state finishes.")]
        public string SandAmbusherAttackAnimatorState = "Worm_LoopingDive";
        ...
        public Vector3 SandAmbusherBodyPrefabLocalEulerAngles = new Vector3(-90f, 0f, 0f);
    ...
    public sealed class DroneVisualTuning
    {
        ...
        [Tooltip("Local position offset applied to the trail prefab relative to the drone visual root.")]
    ...
    public sealed class StormPyramidTuning
    {
        ...
        [Range(0.05f, 1f)] public float GroundWarningRingFill = 0.87f;
        ...
        [Range(0.05f, 1f)] public float GroundWarningClosingRingFill = 0.52f;
        ...
        [Header("Ground Strike Warning Hazard Bezel")]
        [Tooltip("Leaning hazard bars ringing the danger zone between its outer and inner rings. Set to 0 to hide the bezel.")]
        [Range(0, 48)] public int GroundWarningBezelBarCount = 20;
        [Tooltip("Radius the hazard bezel sits at as a fraction of the strike radius.")]
        ...
        [Tooltip("Sigil spin in degrees per second when the warning first appears. Use the opposite sign to the bezel so the two counter-rotate.")]
        ...
        [Range(0f, 3f)] public float GroundWarningIonColumnHeightStart = 0.2f;
        [Tooltip("Height of the ion columns in the last moments before the strike fires, as a fraction of the strike radius.")]
        [Range(0f, 3f)] public float GroundWarningIonColumnHeightEnd = 0.62f;
        [Tooltip("Extra height each ion column gains at the crest of the shimmer wave travelling around the sigil, as a fraction of its current height.")]
        [Range(0f, 1f)] public float GroundWarningIonColumnShimmer = 0.24f;
        [Tooltip("Speed of the shimmer wave travelling around the ion columns.")]
        [Min(0f)] public float GroundWarningIonColumnShimmerSpeed = 5.5f;
    ...
    public sealed class RingTuning
    {
        ...
        [Tooltip("Base gold awarded by a coin ring before its random integer multiplier is applied.")]
        [Min(1)] public int GoldReward = 25;
        [Tooltip("Lowest integer multiplier a coin ring can apply to its base gold reward.")]
        [Min(1)] public int CoinRingMinimumGoldMultiplier = 1;
        [Tooltip("Highest integer multiplier a coin ring can apply to its base gold reward (inclusive).")]
        [Min(1)] public int CoinRingMaximumGoldMultiplier = 5;
    ...
    public sealed class MusicReactiveSkyTuning
    {
        ...
        public Vector3 CenterOutAnchorWorldOffset = new Vector3(0f, -0.2f, 0f);
        ...
        [Tooltip("Width multiplier applied to every center-out flare line emitted from the drone, thin or broad.")]
    ...
    public sealed class PauseMenuVisualTuning
    {
        ...
        public bool DefaultBloomEnabled = false;
    ...
    public sealed class BoostRingTrailTuning
    {
        ...
        [Range(2, 1024)] public int HueStepCount = 300;
    ...
    public sealed class RailShooterTuning
    {
        ...
        [Tooltip("Local orientation of the coin inside a screen-facing rail-subgame pickup ring.")]
        public Vector3 PickupCoinEulerAngles = new Vector3(90f, 0f, 0f);
        ...
        [Tooltip("Whether recurring rail slots not selected as health rings spawn navigation rings. Disable to leave those slots empty.")]
        public bool SpawnNonHealthNavigationRings;
        ...
        public string ControlsLabel = "WASD MOVE   SHIFT BOOST   CTRL BRAKE   SPACE MANEUVER   LMB FIRE/CHARGE   RMB DRAW SIGILS   Q BOMB";
        ...
        [Tooltip("Width of the ticks drawn on the rift depth meter at each upcoming route split.")]
        [Min(0f)] public float DepthGateMarkerWidth = 2f;
        public Color DepthGateMarkerColor = new Color(0.7f, 0.9f, 1f, 0.55f);
        public Color DepthGateClearedMarkerColor = new Color(0.32f, 1f, 0.58f, 0.8f);
    ...
    public sealed class TitleScreenTuning
    {
        ...
        [Tooltip("FMOD event fired when a menu entry is confirmed. Leave empty for a silent confirm.")]
        public string ButtonEventPath = "event:/titlebutton";
        [Range(0f, 1f)] public float ButtonVolume = 1f;
        [Tooltip("Play the button event when an entry is confirmed.")]
        public bool PlayButtonOnConfirm = true;
        [Tooltip("FMOD event fired when the highlight swaps between START and OPTIONS. Leave empty for silent movement.")]
